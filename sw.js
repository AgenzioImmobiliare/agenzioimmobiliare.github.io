...
var CACHE = 'lecase-v83';            /* bump: richieste verso altri siti escluse dal SW (25/09/2026) */
...
self.addEventListener('fetch', function (e) {
  ...
  /* Richieste verso ALTRI siti (catasto Agenzia Entrate, Worker Cloudflare, CDN…):
     il service worker non le tocca. Prima, se fallivano (es. CORS), la riserva
     qui sotto restituiva la pagina del gestionale con stato 200: un finto
     "tutto ok". Ora l'errore arriva vero alla pagina. (25/09/2026)
     NB: le foto Firebase Storage sono gestite sopra e restano in cache. */
  ...
  /* Altri asset (immagini, font, css, moduli ES di src/modules/): network-first
     con fallback alla cache — così un modulo aggiornato arriva subito. */
  e.respondWith(
    fetch(e.request).then(function (r) {

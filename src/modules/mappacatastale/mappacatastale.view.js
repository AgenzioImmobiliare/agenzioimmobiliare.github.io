...
(function(){
  ...
  window.apriMappaCatastale=function(immUuid, opz){
    ...
    /* [25 set notte] Il catasto ha un piano tutto suo, sopra gli strati PAI.
       ...
       la foto (moltiplica) invece di coprirla: il crema schiarito diventa
       bianco e il bianco moltiplicato non cambia la foto; i confini neri e
       le case arancioni restano. La fusione funziona solo su un piano
    ...
    if(!_el('mcat-stile-foto')){
      ...
      st.textContent='#mcat-map.mcat-foto .leaflet-mcatCatasto-pane{mix-blend-mode:multiply}'
        +'#mcat-map.mcat-foto .mcat-ov{opacity:1!important;filter:brightness(1.36)}';

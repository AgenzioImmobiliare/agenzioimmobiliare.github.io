...
function _visWaAttesa(v){
  try{
    ...
    try{
      ...
      if(v.id){
        var FORM_BASE = 'https://agenzioimmobiliare.github.io/richiesta.html';
        ...
        msg += '\n\nSe vuoi puoi anche compilare qui la tua richiesta più nel dettaglio, così la ricerca sarà più precisa: ' + formUrl;
      }
    }catch(e){}

...
function brochureImmobile(i){
  try{
    ...
    var agenziaNome = 'FRIMM';
    var agenziaSub = 'franchisee IMMOBILIARE';
...
+ '<div class="sheet">'
+ '  <div class="brk-head">'
+ '    <div class="logo"><div><div class="logo-box">' + agenziaNome + '</div><div class="logo-sub">' + agenziaSub + '</div></div></div>'

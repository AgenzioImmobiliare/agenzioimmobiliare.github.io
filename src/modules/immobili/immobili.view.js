...
function renderImmobili(){
  ...
  /* Pannello incarichi in scadenza (in cima alla sezione Immobili) */
  try{ if(typeof window.renderIncarichiScadenza==='function') window.renderIncarichiScadenza('imm-incarichi-scadenza'); }catch(_e){}

...
function mobRenderAttivita(){
  ...
  lista = lista.slice().sort(function(x,y){
    ...
    /* [FIX] ord['Da fare'] vale 0, ma 0||9 dà 9 (0 è falsy)! Le 'Da fare' finivano
       in fondo invece che in cima. Uso controllo esplicito che accetta lo zero. */
    var oa = (ord[a.stato]!==undefined) ? ord[a.stato] : 9;
    var ob = (ord[b.stato]!==undefined) ? ord[b.stato] : 9;
  ...
  /* [UI] Pulsante "Nuova Attività" spostato IN ALTO (più comodo da raggiungere) */
  html += '<button onclick="mobAttivitaModifica(undefined)" style="width:100%;padding:12px;background:linear-gradient(135deg,#059669,#047857);color:white;border:none;border-radius:12px;font-weight:700;font-size:0.88rem;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;margin-bottom:14px;">'

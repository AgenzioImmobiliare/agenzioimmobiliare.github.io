...
function mobOpenSchedaCliente(idx){
  ...
  /* [25 set 2026] Ricerche catastali agganciate a questo contatto (index.html) */
  try{ if(typeof window.renderRicercheCatCli === 'function') html += window.renderRicercheCatCli(cl); }catch(e){}

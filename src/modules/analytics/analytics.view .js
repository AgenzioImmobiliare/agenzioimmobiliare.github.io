...
function _rvtl(vis){
  ...
  /* [15 set 2026] Esposta anche _anEnsureChart. L'Osservatorio, che sta nel
     monolite, la cerca con typeof _anEnsureChart: non trovandola non caricava
     Chart.js, e i suoi quattro grafici restavano vuoti in silenzio a meno che
     non si fosse aperto Analytics prima nella stessa sessione. */
  window._anEnsureChart = _anEnsureChart;
  return {

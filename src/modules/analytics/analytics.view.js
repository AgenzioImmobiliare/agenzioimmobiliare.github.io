...
function _buildBrochureHTML(idx){
  var im=(D.immobili||[])[idx]; if(!im) return '';
  ...
  html+='<div class="br-head"><div><div class="br-agency">Le case dalla A allo Z.io</div><div class="br-agent">Vincenzo Carnicelli · Agropoli (SA) · 393 297 0082</div></div>'
      +'<div class="br-ref">'+(im.ref?('Rif. '+im.ref):('Rif. '+(idx+1)))+'</div></div>';
  /* titolo + prezzo */
  ...
  /* descrizione */
  if(im.descr){
    html+='<div class="br-sec-title">Descrizione</div><div class="br-descr">'+String(im.descr).replace(/</g,'&lt;').replace(/\n/g,'<br>')+'</div>';
  }
  /* distanze */
  if(distArr.length){
  ...
  html+='<div class="br-foot">Per informazioni e appuntamenti: Vincenzo Carnicelli · 393 297 0082 · Le case dalla A allo Z.io</div>';
  html+='</div>';
  return html;
}

    ...
    if(Array.isArray(p.modAgenteRighe) && p.modAgenteRighe.length){
      ...
      if(_fattTot > 0){
        ...
        if(FP.trovate){
          ...
          if(FP.nonAttribuito > 0.009) R.controlli.push({et:etich,
            msg:'sulla fattura ' + FP.numeriNonAttr.join(', ') + ' ci sono pagamenti per ' + _ceE(FP.nonAttribuito)
          ...
          R.controlli.push({et:etich,
            msg:'la scheda destina ' + _ceE(_fattTot) + ' a una fattura che non risulta agganciata: '

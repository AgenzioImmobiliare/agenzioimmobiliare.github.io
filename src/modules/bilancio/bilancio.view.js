...
function _ceDocCassa(R){
  ...
  var righeE = tit
    ? [['Provvigioni incassate dai clienti', C.quoteRicevute, 'quote di venditori e acquirenti segnate come pagate'],
    ...
    : [['Quote agente incassate', C.quoteRicevute, R.quanteProv + ' provvigioni maturate nel ' + R.anno],
       ['Altre entrate incassate', C.entrateIncassate, '']];
  var righeU = tit
    ? [['Compensi pagati agli agenti', C.pagatoAgenti, 'quote nette girate'],
...
function _ceStampaCassa(R, conDettaglio){
  ...
  var h = '<table class="out"><tr>'
    + col('Entrato', (R.prospettiva === 'titolare'
                      ? [['Provvigioni incassate dai clienti', C.quoteRicevute]]
                      : [['Quote agente incassate', C.quoteRicevute]])
                      .concat([['Altre entrate incassate', C.entrateIncassate]])
                      .concat(_ceRigheAMano(R, 'entrate')),
          'Totale entrato', C.incassato, CE_TINTA.ricavi)
    + col('Uscito', (R.prospettiva === 'titolare'
                     ? [['Compensi pagati agli agenti', C.pagatoAgenti]]
                     : [['Trattenute ufficio', C.trattenute]])
                     .concat([['Spese di struttura pagate', C.pagatoStruttura],
                              ['F24 versati', C.pagatoImposte]])

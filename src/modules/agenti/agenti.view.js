...
function openAgenteSchedaPopup(i){
  ...
  /* Data robusta: le provvigioni possono avere la data in campi diversi a
     seconda di come/quando sono state create. Prova in ordine di affidabilità. */
  const _provData=(p)=>p.data||p.dataAcc||p.dataAtto||p.dataRogito||p.dprop||p.dataProvvigione||'';
